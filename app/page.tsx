  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 pt-16 pb-8 overhead-spotlight top-vignette">
      <div className="max-w-3xl w-full text-center space-y-12 my-auto">
        ...
        <h2 className="text-xl md:text-2xl text-champagne font-light tracking-wide">A Legacy in Focus</h2>
        ...
        <div className="pt-8 flex justify-center gap-4">
          <Link
            href="/contact"
            className="inline-block px-8 py-3 border-2 border-champagne text-champagne hover:text-[#1A0000] hover:bg-champagne transition-all duration-300 text-lg tracking-wide"
          >
            Submit Portfolio
          </Link>
        </div>
